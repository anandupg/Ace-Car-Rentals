...
<body>
    ...
    <nav class="navbar bg-secondary navbar-dark">
        ...
        <div class="navbar-nav w-100">
            ...
            <a href="driver.php" class="nav-item nav-link active text-white"><i class="fas fa-car-side"></i> Drivers</a>
    ...
    <i class="fa fa-bars"></i>
            ...
            <?php
            include "../connect.php";
$sql_pending = "SELECT * FROM tbl_driver WHERE status='Pending';";
        ...
        <div class="col-md-12">
            <div class="bg-secondary rounded p-4">
                <form method="POST" action="" id="carDetailsForm">
                    <h6 class="mb-4">Driver Pending Table</h6>
                    <div class="table-responsive">
                        <table class="table table custom-table" style="color: white;">
                            ...
                            <tbody>
                                ...
                                // Fetch driver details from tbl_driver
                                $sql = "SELECT * FROM tbl_driver  WHERE status='Pending'";
                                ...
                                if ($result->num_rows > 0) {
                                    while ($row = $result->fetch_assoc()) {
                                        ...
                                        echo '<a href="view_driver.php?driver_id=' . $row['driver_id'] . '" class="btn btn-primary">View More</a>';

                                        echo '</td>';
                                        echo '</tr>';
                                    }
                                } else {
                                    echo '<tr><td colspan="6">No driver details found</td></tr>';
                                }
                                ?>
                            </tbody>
                        </table>
...
$sql_pending = "SELECT * FROM tbl_driver WHERE status='Approved';";
$result_pending = $conn->query($sql_pending);
?>
<?php if ($result_pending && $result_pending->num_rows > 0): ?>
<div class="container-fluid pt-4 px-4">
    <div class="row">
        <div class="col-md-12">
            <div class="bg-secondary rounded p-4">
                <form method="POST" action="" id="carDetailsForm">
                    <h6 class="mb-4">Driver Approved Table</h6>
                    <div class="table-responsive">
                        <table class="table table custom-table" style="color: white;">
                            <thead>
                                <tr>
...
include "../connect.php";
                                // Fetch driver details from tbl_driver
                                $sql = "SELECT * FROM tbl_driver WHERE status='Approved'";
                                $result = $conn->query($sql);
...
$sql_pending = "SELECT * FROM tbl_driver WHERE status='Declined';";
$result_pending = $conn->query($sql_pending);
?>
<?php if ($result_pending && $result_pending->num_rows > 0): ?>
<div class="container-fluid pt-4 px-4">
    <div class="row">
        <div class="col-md-12">
            <div class="bg-secondary rounded p-4">
                <form method="POST" action="" id="carDetailsForm">
                    <h6 class="mb-4">Driver Declined Table</h6>
                    <div class="table-responsive">
                        <table class="table table custom-table" style="color: white;">
                            <thead>
                                <tr>
...
include "../connect.php";
                                // Fetch driver details from tbl_driver
                                $sql = "SELECT * FROM tbl_driver WHERE status='Declined'";
                                $result = $conn->query($sql);
