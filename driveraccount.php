...
if (!empty($_SESSION['login_id'])) {
    ...
    $sql = "SELECT * FROM tbl_driver where login_id='$login_id';";
...
if (isset($_POST['profile_update'])) {
    ...
    $sql_update = "UPDATE tbl_driver SET fname='$fname',lname='$lname',phone='$phone',image='$image_name' WHERE login_id='$login_id';";
...
window.location.replace("driveraccount.php");
}
});
      ...
      <div class="row">
        <div class="col-md-4">
          ...
          <?php if (!empty($row['image'])): ?>
           <?php $user_image = "driver_docs/" . $row['image'];?>
...
<div class="col-sm-8">
  ...
  <span id="imageError" class="error-message"></span>
    ...
    <?php if(isset($row['image']) && !empty($row['image'])): ?>
        <img id="image_preview" src="driver_docs/<?php echo $row['image']; ?>" alt="Preview" style="max-width: 100px; max-height: 100px; cursor: pointer;"  onclick="showEnlargedImage('<?php echo $user_image; ?>');">
    <?php endif; ?>
</div>
              </div>
              <div class="form-group row">
